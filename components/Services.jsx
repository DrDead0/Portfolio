              ...
              >
                ...
                <div className='p-6'>
                  ...
                  <div className='flex gap-4 pt-4 justify-end'>
                    <button
                      onClick={closeModal}
                      className='px-4 py-2 text-sm bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300 font-medium'
                    >
                      Close
                    </button>
                  </div>
