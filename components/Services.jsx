          ...
          {selectedService && (
            ...
            >
              ...
              >
                ...
                <div className='p-6'>
                  <div className='mb-6'>
                    <h3 className='text-lg font-semibold text-gray-700 dark:text-white mb-3'>Service Overview</h3>
                  ...
                  <div className='mb-6'>
                    <h3 className='text-lg font-semibold text-gray-700 dark:text-white mb-3'>Technologies & Skills</h3>
                  ...
                  <div className='flex gap-4 pt-4'>
                    <button
                      onClick={closeModal}
                      className='flex-1 px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300 font-medium'
                    >
                      Close
                    </button>
                    <a
                      ...
                      className='flex-1 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-300 font-medium text-center'
                    >
                      Learn More
                    </a>
                  </div>
