...
const Header = () => {
  ...
  return (
    <div ref={headerRef} className='w-11/12 max-w-3xl text-center mx-auto flex flex-col items-center justify-center gap-3 pt-28 pb-16 relative z-10'>
      <motion.div
      initial={{scale: 0}}
      whileInView={{scale: 1}}
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-2 font-Ovo'>
            Hi! I'm Ashish Chaurasiya <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
    <motion.h1 
